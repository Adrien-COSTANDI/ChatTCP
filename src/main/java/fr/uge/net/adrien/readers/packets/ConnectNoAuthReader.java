...
public class ConnectNoAuthReader implements Reader<ConnectNoAuth> {

  private final StringReader stringReader = new StringReader();
  private ConnectNoAuth value;
  ...
  public ProcessStatus process(ByteBuffer buffer) {
    ...
    switch (status) {
      case DONE -> {
        value = new ConnectNoAuth(stringReader.get());
        state = State.DONE;
